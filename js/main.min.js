...
function starSky() {
  ...
  $('document').ready(function () {
    ...
    canvaH = $('.welcome').height();
    canvaW = $('.welcome').width(); // Get the canvas

    canvas = $('#stars'); // Fill out the canvas

    canvas.attr('height', canvaH);
    canvas.attr('width', canvaW);
    ...
    for (var i = 0; i < numStars; i++) {
      ...
      var length = 1.5 + Math.random() * 2.5;
